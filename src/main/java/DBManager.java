...
public class DBManager {
     ...
     *
     * Jos tietokantayhteyden avaaminen ep√§onnistuu, keskeytet√§√§n ohjelman
     * suoritus.
     */
    public DBManager() {
        try {
            ...
            System.out.println("Yhteyden avaaminen tietokantaan ep√§onnistui: "
                    + poikkeus.getMessage());
            // Lopetetaan ohjelman suoritus, jos tietokantayhteys ep√§onnistuu
            System.exit(0);
        }
    }
    ...
    /**
     * Hakee asiakkaat jossa etunimi tai sukunimi t√§sm√§√§v√§t hakusanoihin.
     *
     * @param nimi
     * @return
     * @throws SQLException
    ...
    /**
     * Hakee asiakkaat jossa etunimi ja sukunimi t√§sm√§√§v√§t hakusanoihin.
     *
     * @param enimi
     * @param snimi
     * @return
    ...
    public void lisaaKohde(String asiakasid, String tyyppi, String tarjous, String osoite, String eralkm)
            throws SQLException {
        System.out.println("luodaan uusi ty√∂kohde: " + asiakasid + tyyppi + osoite
                + eralkm);
    ...
    public ArrayList<String> haeTarvikkeet() throws SQLException {
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT * "
                    ...
                    + "ORDER BY tarvikeid");
            while (rs.next()) {
                String tarvike = rs.getString("nimi") + " - " + rs.getDouble("ostohinta") + " Ä";
    ...
    public void close() {
        try {
            ...
            System.out.println("Yhteyden sulkeminen ep√§onnistui..");
        }
    }
}
